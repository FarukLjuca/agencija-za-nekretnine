...
namespace EFM
{
    ...
    public class Nekretnina
    {
        ...
        public Nekretnina(string Lokacija, string opis, EnumTipNekretnine TipNekretnine, decimal cijena, List<BitmapImage> slike, bool DaLiJeCista = false, bool DaLiJeRezervisana = false)
        {
