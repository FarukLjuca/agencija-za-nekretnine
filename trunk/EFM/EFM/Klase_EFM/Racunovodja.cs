...
namespace EFM
{
    public class Racunovodja : Zaposlenik
    {
        ...
        public Racunovodja(string Ime, string Prezime, DateTime DatumRodjenja, string BrojLicneKarte, double Plata, string Username, string Password, string Pozicija)
